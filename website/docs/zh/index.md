...
hero:
  ...
  tagline: Claude Code · Codex · Cursor —— 汇于一处，附带 token 与成本核算
  image:
    src: /logo.svg
...
features:
  - title: 一份列表，三种工具
    details: 将每一条 Claude Code、Codex 和 Cursor 会话汇聚到一起浏览。可按来源、项目文件夹、日期范围以及全文搜索进行筛选，并按最近更新、成本、token 或体积排序。
    icon: 🗂️
  - title: 多选 → ZIP 导出
  ...
  - title: 成本估算
    ...
    icon: 💰
  - title: 本地且私密
    details: 直接读取你本地的会话文件 —— 没有任何数据离开你的机器。纯 Python 3.9+ 标准库，零依赖。Cursor 的数据库以严格只读方式打开。
    icon: 🔒
---
