...
export default defineConfig({
  ...
  lang: 'en',
  locales: [
    { lang: 'en', label: 'English', title: 'Session Exporter', description: 'Browse & export your Claude Code / Codex / Cursor history' },
    { lang: 'zh', label: '简体中文', title: 'Session Exporter', description: '浏览并导出你的 Claude Code / Codex / Cursor 会话历史' },
    { lang: 'ja', label: '日本語', title: 'Session Exporter', description: 'Claude Code / Codex / Cursor の履歴を閲覧・エクスポート' },
  ],
  themeConfig: {
