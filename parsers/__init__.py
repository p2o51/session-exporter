...
Each source parser (claude, codex, cursor, antigravity, pi) is a module exposing
...
SOURCE: str
    The source id, one of "claude" | "codex" | "cursor" | "antigravity" | "pi".
...
_SOURCE_MODULES = ["claude", "codex", "cursor", "antigravity", "pi"]
